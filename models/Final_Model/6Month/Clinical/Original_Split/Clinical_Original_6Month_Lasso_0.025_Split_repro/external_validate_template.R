...
source(file.path("C:/Users/niced/Desktop/TBI_risk_factor_R/소스코드/Clinical_Original_6Month_Lasso_0.025_Split_repro","predict_template.R"))

# df_ext : 외부 원자료(사용자 준비)
# 응답변수명: "GOSE_6_Unfav" (0/1 factor or character -> factor(c("0","1")))
